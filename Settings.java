...
//
    ...
    private static SettingsProperty threeArguments(Object[] settings)
    {
        ...
        {
            return newSetting((String) settings[0], (Boolean) settings[1],(String) settings[1]);
        }else if (settings[0] instanceof Integer && settings[1] instanceof Boolean && settings[2] instanceof String)
        {
            return newSetting((Integer) settings[0], (Boolean) settings[1],(String) settings[1]);
        }else if (settings[0] instanceof Double && settings[1] instanceof Boolean && settings[2] instanceof String)
        {
            return newSetting((Double) settings[0], (Boolean) settings[1],(String) settings[1]);
        }else if (settings[0] instanceof Boolean && settings[1] instanceof Boolean && settings[2] instanceof String)
        {
            return newSetting((Boolean) settings[0], (Boolean) settings[1],(String) settings[1]);
        }
    ...
    private static SettingsProperty fourArguments(Object[] settings)
    {
        ...
        {
            LOG.warning(bundle.getString("lessThenFourArgs"));//TODO
            return newSetting();
        }
        ...
        LOG.warning(bundle.getString("wrongTypeFourArgs"));//TODO
        return newSetting();
    }
